...
namespace CouriersManagementDb.Controllers
{
    public class CouriersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourierID,Name,PhoneNumber")] Courier courier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourierID,Name,PhoneNumber")] Courier courier)
        {
