...
namespace CouriersManagementDb.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var couriersManagementDbContext = _context.Payments.Include(p => p.Customer).Include(p => p.Shipment);
        ...
        public async Task<IActionResult> Create([Bind("PaymentID,Timestamp,Amount,ShipmentID,CustomerID")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentID,Timestamp,Amount,ShipmentID,CustomerID")] Payment payment)
        {
