...
namespace CouriersManagementDb.Controllers
{
    public class TrackingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TrackingID,Status,Timestamp,PackageID,LocationID")] Tracking tracking)
        {
            ...
            ViewData["LocationID"] = new SelectList(_context.Locations, "LocationID", "Address", tracking.LocationID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrackingID,Status,Timestamp,PackageID,LocationID")] Tracking tracking)
        {
